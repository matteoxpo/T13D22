...
Если файл пустой или не существует - вывести "n/a". Сборка проекта должна осуществляться при помощи Makefile.
...
| Input | Output |
| ------ | ------ |
| 1<br>src/text.txt<br>2<br>Some text | Aloha!<br>Aloha!<br>Aloha! |
